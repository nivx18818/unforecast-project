    ...
    >
      <div className="flex flex-col gap-12 items-center w-full max-w-4xl">
        ...
        <div className="flex flex-col gap-4 items-center w-full">
          <div className="relative w-[33px] h-[24px]">
          ...
          <h2
            id="messages-heading"
            className="font-display font-bold text-[60px] leading-[60px] text-foreground text-center"
          >
            Secret Messages
          </h2>
          <div className="max-w-2xl pt-2">
            <p className="font-sans text-[20px] leading-[28px] text-muted-foreground text-center">
        ...
        <div className="flex w-full justify-center">
          <a
            ...
            className="inline-flex h-16 items-center justify-center px-12 rounded-full bg-primary border border-primary text-primary-foreground font-sans font-bold text-[18px] leading-[28px] tracking-[0.9px] uppercase shadow-[0_0_20px_rgba(227,170,49,0.3)] transition-all duration-300 hover:shadow-[0_0_20px_rgba(227,170,49,0.5)] hover:brightness-110 focus-visible:outline-2 focus-visible:outline-ring focus-visible:outline-offset-2"
          >
