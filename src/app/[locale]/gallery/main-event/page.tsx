...
export const metadata: Metadata = {
  title: "Main Event Gallery | Ceremony of Gratitude and Growth",
  description: "View the full main-event gallery from the Unforecast Project.",
};

export default async function MainEventGalleryPage(props: {
  ...
  const images = getGalleryImages(["main-event"]);
